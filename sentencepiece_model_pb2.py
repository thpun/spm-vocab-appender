...
# source: sentencepiece/src/sentencepiece_model.proto
...
TrainerSpec = _reflection.GeneratedProtocolMessageType('TrainerSpec', (_message.Message,), dict(
  ...
  __module__ = 'sentencepiece.src.sentencepiece_model_pb2'
